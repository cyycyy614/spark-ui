    ...
    <el-form :model="form" ref="form" label-suffix=":" :label-width="setPx(labelWidth)">
      <el-form-item :label="username.label || '用户名'" :rules="username.rules" :label-width="setPx(username.labelWidth)" v-if="!username.hide" prop="username">
        <el-tooltip :content="username.tip" :disabled="username.tip===undefined" placement="top-start">
          <el-input v-model="form.username" size="small" :prefix-icon="username.prefixIcon || 'el-icon-user'" :placeholder="username.placeholder || '请输入用户名'" :autocomplete="username.autocomplete">
          </el-input>
        </el-tooltip>
      </el-form-item>
      <el-form-item :label="password.label || '密码'" :rules="password.rules" :label-width="setPx(password.labelWidth)" v-if="!password.hide" prop="password">
        <el-tooltip :content="password.tip" :disabled="password.tip===undefined" placement="top-start">
          <el-input type="password" size="small" :prefix-icon="password.prefixIcon || 'el-icon-unlock'" :placeholder="password.placeholder || '请输入密码'" show-password v-model="form.password"
            :autocomplete="password.autocomplete"></el-input>
        </el-tooltip>
      </el-form-item>
      <el-form-item :label="code.label || '验证码'" :rules="code.rules" v-if="!code.hide" :label-width="setPx(code.labelWidth)" prop="code">
        <el-tooltip :content="code.tip" :disabled="code.tip===undefined" placement="top-start">
