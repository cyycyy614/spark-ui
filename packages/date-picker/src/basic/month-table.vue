...
<script type="text/babel">
  ...
  import { isDate, range, getDayCountOfMonth, nextDate } from 'spark-ui/src/utils/date-util';
  import { hasClass } from 'spark-ui/src/utils/dom';
  import { arrayFindIndex, coerceTruthyValueToArray, arrayFind } from 'spark-ui/src/utils/util';
