...
<script type="text/babel">
  ...
  import { isDate, range, nextDate, getDayCountOfYear } from 'spark-ui/src/utils/date-util';
  import { arrayFindIndex, coerceTruthyValueToArray } from 'spark-ui/src/utils/util';
